...
echo 'add a remote pseudo for the cim-energy repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/cim-energy
